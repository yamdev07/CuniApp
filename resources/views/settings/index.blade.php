                ...
                <div class="settings-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="alert_threshold" class="form-control"
                               value="{{ \App\Models\Setting::get('alert_threshold', 80) }}" min="1" max="100">
                        <small style="color: var(--text-tertiary); font-size: 12px; margin-top: 6px; display: block;">
    ...
    <div class="cuni-card">
        ...
        <div class="card-body">
            <form action="{{ route('settings.update') }}" method="POST">
                @csrf
                <div class="settings-grid">
                    <!-- ✅ THEME DROPDOWN RESTORED -->
                    <div class="form-group">
                        <label class="form-label">Thème</label>
                        <select name="theme" class="form-select"
                                onchange="document.body.classList.toggle('theme-dark', this.value === 'dark')">
                        ...
                        <small style="color: var(--text-tertiary); font-size: 12px; margin-top: 6px; display: block;">
                            <i class="bi bi-info-circle"></i> Le thème s'appliquera après rechargement de la page
                        </small>
                    </div>

                    <!-- ✅ LANGUAGE SELECTOR (FIXED & PERSISTENT) -->
                    <div class="form-group">
                        ...
                        <small style="color: var(--text-tertiary); font-size: 12px; margin-top: 6px; display: block;">
                            <i class="bi bi-info-circle"></i> La langue s'appliquera après rechargement de la page
                        </small>
                    </div>
                </div>
