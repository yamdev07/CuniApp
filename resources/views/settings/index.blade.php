                ...
                <div class="settings-grid">
                    ...
                    <div class="form-group">
                        <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                            <input type="checkbox" name="notifications_email" {{ \App\Models\Setting::get('notifications_email', '0') == '1' ? 'checked' : '' }} style="width: 18px; height: 18px;">
                            <span class="form-label" style="margin: 0;">Notifications par email</span>
                        </label>
                    </div>
                    <div class="form-group">
                        <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                            <input type="checkbox" name="notifications_dashboard" {{ \App\Models\Setting::get('notifications_dashboard', '0') == '1' ? 'checked' : '' }} style="width: 18px; height: 18px;">
...
<div class="tab-content" id="system-tab">
    <div class="cuni-card">
        <div class="card-header-custom">
            <h3 class="card-title">
                <i class="bi bi-hdd"></i> Gestion du Système
            </h3>
        </div>
        <div class="card-body">
            <div class="settings-grid">
                ...
                <div class="cuni-card" style="margin: 0; background: var(--surface-alt);">
                    ...
                    <form action="{{ route('settings.clear-cache') }}" method="POST" style="display: inline;">
                        @csrf
                        <button type="submit" class="btn-cuni danger" onclick="return confirm('Voulez-vous vraiment vider le cache ?')">
