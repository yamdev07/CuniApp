                ...
                <div class="settings-grid">
                    ...
                    <div class="form-group">
                        <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                            <input type="checkbox" name="notifications_email" {{ auth()->user()->notifications_email ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                            <input type="checkbox" name="notifications_dashboard" {{ auth()->user()->notifications_dashboard ? 'checked' : '' }}>
                            <span class="form-label" style="margin: 0;">🔔 Notifications tableau de bord</span>
                        </label>
                        <small class="text-gray-500 text-xs mt-1">
