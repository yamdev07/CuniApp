...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="card-body">
            ...
            <div style="margin-top: 24px; padding: 16px; background: var(--primary-subtle); border-radius: var(--radius-lg);">
                ...
                <div style="display: flex; align-items: center; gap: 12px;">
                    <div style="width: 40px; height: 40px; border-radius: var(--radius); background: var(--surface); display: flex; align-items: center; justify-content: center;">
                        @if($provider === 'momo')
                            <i class="bi bi-phone" style="color: #FFCC00; font-size: 20px;"></i>
                        @elseif($provider === 'celtis')
                            <i class="bi bi-wallet2" style="color: #00A651; font-size: 20px;"></i>
                        @elseif($provider === 'moov')
                            <i class="bi bi-phone-vibrate" style="color: #FF6B00; font-size: 20px;"></i>
                        @endif
                    </div>
                    <div>
                        <div style="font-weight: 600; color: var(--text-primary);">
                            @switch($provider)
                                @case('momo') MTN MoMo @break
                                @case('celtis') Celtis Cash @break
                                @case('moov') Moov Pay @break
    ...
    <div class="cuni-card">
        ...
        <div class="card-body">
            <form action="{{ route('payment.process') }}" method="POST" id="paymentForm">
                ...
                <div class="form-group">
                    ...
                    <div class="form-input-wrapper" style="position: relative;">
                        ...
                        <i class="bi bi-phone" style="position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: var(--gray-400); font-size: 16px;"></i>
                    </div>
                ...
                <!-- Security Notice -->
                <div style="margin: 24px 0; padding: 16px; background: rgba(59, 130, 246, 0.1); border-radius: var(--radius); border-left: 4px solid var(--primary);">
                ...
                <div class="form-group">
                    <label style="display: flex; align-items: flex-start; gap: 10px; cursor: pointer;">
                        <input type="checkbox" name="confirm_payment" required style="width: 16px; height: 16px; accent-color: var(--primary); margin-top: 2px;">
                        <span style="font-size: 13px; color: var(--text-secondary);">
                            Je confirme vouloir payer <strong>{{ number_format($transaction->amount, 0, ',', ' ') }} FCFA</strong> via {{ ucfirst($provider) }}
                        </span>
                    </label>
                </div>
            ...
            <!-- Help Text -->
            <div style="margin-top: 24px; padding-top: 24px; border-top: 1px solid var(--surface-border); text-align: center;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        submitBtn.innerHTML = '<i class="bi bi-hourglass-split"></i> <span>Traitement en cours...</span>';
