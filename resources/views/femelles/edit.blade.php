...
@section('title', 'Modifier Femelle - CuniApp Élevage')
...
<div class="cuni-card">
    <div class="card-header-custom">
        <h3 class="card-title">
            ...
            Informations de la Femelle
        </h3>
        <a href="{{ route('femelles.index') }}" class="btn-cuni sm secondary">
            <i class="bi bi-arrow-left"></i>
            Retour
        </a>
    </div>
    <div class="card-body">
        <form action="{{ route('femelles.update', $femelle->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="settings-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nom" class="form-control" value="{{ old('nom', $femelle->nom) }}" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Race</label>
                    <input type="text" name="race" class="form-control" value="{{ old('race', $femelle->race) }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date_naissance" class="form-control" value="{{ old('date_naissance', $femelle->date_naissance) }}">
                </div>
                <div class="form-group">
