...
<div class="legal-page">
    ...
    <div class="cuni-card mb-6">
        <div class="card-body" style="padding: 40px 32px; text-align: center; background: linear-gradient(135deg, var(--primary-subtle) 0%, var(--surface) 100%);">
            <div style="width: 72px; height: 72px; margin: 0 auto 20px; background: linear-gradient(135deg, var(--primary) 0%, var(--accent-cyan) 100%); border-radius: var(--radius-xl); display: flex; align-items: center; justify-content: center; box-shadow: var(--shadow-lg);">
    ...
    <div class="cuni-card">
        <div class="card-body legal-content">
            ...
            <article id="article-2" class="legal-section">
                ...
                <ul class="legal-list">
                    <li><i class="bi bi-check-circle-fill"></i> Suivre le cycle de reproduction (saillie, palpation, mise bas, sevrage)</li>
                    <li><i class="bi bi-check-circle-fill"></i> Gérer le cheptel, les portées et l'historique reproductif</li>
                    <li><i class="bi bi-check-circle-fill"></i> Émettre des factures PDF et suivre les paiements</li>
                    <li><i class="bi bi-check-circle-fill"></i> Gérer plusieurs fermes/entreprises via un compte multi-tenant</li>
                    <li><i class="bi bi-check-circle-fill"></i> Accéder à des tableaux de bord analytiques et indicateurs de performance</li>
                </ul>
                <p>
            ...
            <article id="article-4" class="legal-section">
                ...
                <ul class="legal-list">
                    <li><i class="bi bi-arrow-repeat"></i> Les abonnements sont renouvelés automatiquement sauf résiliation avant la date d'échéance</li>
                    <li><i class="bi bi-arrow-repeat"></i> Vous pouvez gérer votre abonnement et annuler le renouvellement depuis votre espace « Paramètres »</li>
                    <li><i class="bi bi-arrow-repeat"></i> Aucun remboursement partiel n'est accordé pour les périodes non utilisées, sauf obligation légale</li>
                </ul>

                <h3>4.4 Facturation</h3>
                <p>
                    Une facture PDF est générée automatiquement après chaque paiement et disponible dans votre espace client.
                </p>
            </article>
            ...
            <article id="article-5" class="legal-section">
                ...
                <p>En résumé :</p>
                <ul class="legal-list">
                    <li><i class="bi bi-database"></i> Nous collectons les données nécessaires au fonctionnement du service (compte, données d'élevage, facturation)</li>
                    <li><i class="bi bi-database"></i> Vos données d'élevage vous appartiennent ; vous pouvez les exporter ou supprimer votre compte à tout moment</li>
                    <li><i class="bi bi-database"></i> Nous ne vendons pas vos données à des tiers. Le partage se limite aux prestataires techniques nécessaires (hébergement, paiement)</li>
                    <li><i class="bi bi-database"></i> Conformément au RGPD et aux lois locales, vous disposez d'un droit d'accès, de rectification et de suppression</li>
                </ul>
            </article>
            ...
            <article id="article-6" class="legal-section">
                ...
                <p>
                    ...
                    sont la propriété exclusive de l'équipe CuniApp et protégés par les lois sur la propriété intellectuelle.
                </p>
                <p>
                    L'utilisation du service vous accorde une licence personnelle, non exclusive, non transférable et révocable 
            ...
            <article id="article-7" class="legal-section">
                ...
                <ul class="legal-list">
                    <li><i class="bi bi-exclamation-triangle"></i> Le service sera ininterrompu, sécurisé ou exempt d'erreurs</li>
                    <li><i class="bi bi-exclamation-triangle"></i> Les calculs (dates de mise bas, indicateurs) remplacent un avis vétérinaire ou professionnel</li>
                    <li><i class="bi bi-exclamation-triangle"></i> Les données saisies seront protégées contre toute perte en cas de force majeure</li>
                </ul>
                ...
                <p>
                    ...
                    Nous ne serons en aucun cas responsables des dommages indirects, pertes de profits, de données ou d'opportunités.
                </p>

                <h3>7.3 Contenu Utilisateur</h3>
                <p>
                    Vous restez seul responsable des données que vous saisissez dans CuniApp. 
                    Nous nous réservons le droit de modérer ou supprimer tout contenu illégal, frauduleux ou contraire aux CGU.
                </p>
            </article>
            ...
            <article id="article-8" class="legal-section">
                ...
                <p>
                    Nous nous réservons le droit de suspendre ou résilier votre accès à CuniApp, sans préavis ni indemnité, 
                ...
                <p>
                    ...
                    En cas de suppression de compte, vos données seront conservées 30 jours avant suppression définitive, 
                ...
                <div class="contact-box">
                    ...
                    <ul class="contact-list">
                        ...
                        <li>
                            ...
                            <a href="https://github.com/yamdev07/CuniApp" target="_blank">github.com/yamdev07/CuniApp</a>
                        </li>
                    </ul>
                </div>
            </article>
    ...
    <div class="cuni-card mt-6" style="border-left: 4px solid var(--primary);">
        <div class="card-body" style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 16px;">
            <p style="margin: 0; color: var(--text-secondary); font-size: 14px;">
                ...
                En continuant à utiliser CuniApp, vous confirmez avoir lu et accepté ces Conditions Générales d'Utilisation.
            </p>
            <div style="display: flex; gap: 12px;">
                ...
                <a href="{{ url()->previous() }}" class="btn-cuni primary">
                    <i class="bi bi-check-lg"></i> J'accepte
                </a>
            </div>
        </div>
    </div>
