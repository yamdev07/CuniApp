        ...
        <div class="card-body">
            <form action="{{ route('sales.store') }}" method="POST" id="saleForm">
                ...
                <div class="form-section" style="margin-top: 24px;">
                    ...
                    <div class="settings-grid">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="unit_price" id="unitPrice" class="form-control"
                                required min="0" value="{{ old('unit_price', 0) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="totalAmountDisplay" class="form-control" readonly
                                style="background: var(--surface-alt); font-weight: 600;" value="0 FCFA">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section" style="margin-top: 24px; border: 2px solid var(--primary-subtle);">
                    ...
                    <div class="alert-box info" style="margin-bottom: 16px;">
                        ...
                        <div>
                            ...
                            <ul style="margin: 8px 0 0 16px; padding: 0;">
                                <li>Chaque lapin peut avoir un prix différent</li>
                                <li>Le total est calculé automatiquement</li>
                                <li>Sélectionnez les lapins spécifiques par catégorie</li>
                            </ul>
                        </div>
                    </div>
                          ...
                          border-radius: var(--radius); cursor: pointer;">
                                    <div style="display: flex; align-items: center; gap: 12px;">
                                        <input type="checkbox" name="selected_males[]" value="{{ $male->id }}"
                                            ...
                                            onchange="updatePriceInputVisibility('males', {{ $male->id }})">
                                        <div style="flex: 1;">
                                    ...
                                    <div class="price-input-container" id="price-males-{{ $male->id }}"
                                        ...
                                        <label style="font-size: 11px; color: var(--text-secondary);">Prix (FCFA)</label>
                                        <input type="number" name="male_prices[]" class="form-control rabbit-price"
                                            data-category="males" placeholder="0" min="0" step="0.01"
                                            onchange="calculateTotalAmount()" style="padding: 8px; font-size: 13px;">
                                    </div>
                                </label>
                            @endforeach
                        </div>
                          ...
                          border-radius: var(--radius); cursor: pointer;">
                                    <div style="display: flex; align-items: center; gap: 12px;">
                                        <input type="checkbox" name="selected_females[]" value="{{ $femelle->id }}"
                                            ...
                                            onchange="updatePriceInputVisibility('females', {{ $femelle->id }})">
                                        <div style="flex: 1;">
                                    ...
                                    <div class="price-input-container" id="price-females-{{ $femelle->id }}"
                                        ...
                                        <input type="number" name="female_prices[]" class="form-control rabbit-price"
                                            data-category="females" placeholder="0" min="0" step="0.01"
                                            onchange="calculateTotalAmount()" style="padding: 8px; font-size: 13px;">
                                    </div>
                                </label>
                            @endforeach
                          ...
                          border-radius: var(--radius); cursor: pointer;">
                                    <div style="display: flex; align-items: center; gap: 12px;">
                                        <input type="checkbox" name="selected_lapereaux[]" value="{{ $lapereau->id }}"
                                            ...
                                            onchange="updatePriceInputVisibility('lapereaux', {{ $lapereau->id }})">
                                        <div style="flex: 1;">
                                    ...
                                    <div class="price-input-container" id="price-lapereaux-{{ $lapereau->id }}"
                                        ...
                                        <input type="number" name="lapereau_prices[]" class="form-control rabbit-price"
                                            data-category="lapereaux" placeholder="0" min="0" step="0.01"
                                            onchange="calculateTotalAmount()" style="padding: 8px; font-size: 13px;">
                                    </div>
                                </label>
                            @endforeach
                    ...
                    <div
                        style="margin-top: 24px; padding: 16px; background: var(--primary-subtle); 
                border-radius: var(--radius-lg);">
                    ...
                    flex-wrap: wrap; gap: 12px;">
                        ...
                        <div id="quantityMismatchWarning"
                            style="margin-top: 12px; padding: 12px; background: rgba(245, 158, 11, 0.1); 
