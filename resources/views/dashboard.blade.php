...
<div class="dash-header cuni-card">
...
<div class="main-grid">
    ...
    <div class="primary-col">
        ...
        <div class="section-block cuni-card">
    ...
    <div class="sidebar-col">
        <!-- Calendar -->
        <div class="widget calendar-widget cuni-card">
        ...
        <!-- Activity Timeline -->
        <div class="widget activity-widget cuni-card">
            <div class="widget-head">
                <h3>Activité</h3>
        ...
        <!-- Alerts -->
        <div class="widget alerts-widget cuni-card">
            <div class="widget-head">
                <h3>Alertes</h3>
...
.dashboard-specific-styles {
    ...
    .metric-icon svg { width: 28px; height: 28px; stroke-width: 2.5; }
    ...
    .perf-card:hover::after { opacity: 0.2; }
    ...
    .card-badge svg { width: 20px; height: 20px; stroke-width: 2.5; }
    ...
    .tile-icon svg { width: 24px; height: 24px; stroke-width: 2.5; }
    ...
    .action-tile:hover .tile-arrow { transform: translateX(6px); }
    ...
    .text-link:hover { color: var(--cuni-blue); }
    ...
    .cal-day:not(.header):hover { background: var(--surface-3); }
    .cal-day.today { background: var(--grad-primary); color: white; box-shadow: var(--glow-blue); }
    ...
    .cal-day.event.purple::after { background: var(--cuni-purple); }
    .cal-day.event.green::after { background: var(--cuni-green); }
