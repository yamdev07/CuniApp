        ...
        <div class="header-wrapper">
            ...
            <div class="header-controls">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = ! open" class="ctrl-btn primary">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            <path d="M12 5v14M5 12h14" />
                        </svg>
                        Nouvelle entrée
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" style="margin-left: 8px;">
                            <path d="M6 9l6 6 6-6" />
                        </svg>
                    </button>
                    ...
                    <div x-show="open"
                        ...
                        style="display: none; position: absolute; right: 0; top: 100%; background: var(--surface-2); border: 1px solid rgba(0, 217, 255, 0.2); border-radius: 12px; padding: 8px; min-width: 200px; z-index: 1000; box-shadow: var(--shadow-2); margin-top: 8px;">

                        <a href="{{ route('males.create') }}" class="dropdown-item" style="display: block; padding: 12px 16px; color: var(--text-primary); text-decoration: none; border-radius: 8px; transition: all 0.3s;">
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--anyx-blue)">
                                    <circle cx="10" cy="14" r="6" />
                                    <path d="M16 8h6V2M22 2l-8.5 8.5" />
                                </svg>
                                <div>
                                    <div style="font-weight: 700;">Mâle</div>
                                    <div style="font-size: 11px; color: var(--text-secondary);">Ajouter un reproducteur mâle</div>
                                </div>
                            </div>
                        </a>

                        <a href="{{ route('femelles.create') }}" class="dropdown-item" style="display: block; padding: 12px 16px; color: var(--text-primary); text-decoration: none; border-radius: 8px; transition: all 0.3s;">
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--anyx-pink)">
                                    <circle cx="12" cy="8" r="6" />
                                    <path d="M12 14v8M9 19h6" />
                                </svg>
                                <div>
                                    <div style="font-weight: 700;">Femelle</div>
                                    <div style="font-size: 11px; color: var(--text-secondary);">Ajouter une reproductrice</div>
                                </div>
                            </div>
                        </a>
                    </div>
...
<style>
    ...
    * {
    ...
    .metric-card.primary .metric-icon svg {
        stroke: var(--anyx-cyan);
    }

    .metric-card.blue .metric-icon svg {
        stroke: var(--anyx-blue);
    }

    .metric-card.pink .metric-icon svg {
        stroke: var(--anyx-pink);
    }

    .metric-card.purple .metric-icon svg {
        stroke: var(--anyx-purple);
    }

    .metric-card.green .metric-icon svg {
        stroke: var(--anyx-green);
    }

    .metric-card.orange .metric-icon svg {
        stroke: var(--anyx-orange);
    }
    ...
    .perf-card.blue::after {
        background: var(--anyx-blue);
    }

    .perf-card.pink::after {
        background: var(--anyx-pink);
    }

    .perf-card.purple::after {
        background: var(--anyx-purple);
    }

    .perf-card.green::after {
        background: var(--anyx-green);
    }
    ...
    .card-badge.purple svg {
        stroke: var(--anyx-purple);
    }

    .card-badge.green svg {
        stroke: var(--anyx-green);
    }
    ...
    .progress-bar.blue {
        background: var(--anyx-blue);
        box-shadow: 0 0 10px var(--anyx-blue);
    }

    .progress-bar.pink {
        background: var(--anyx-pink);
        box-shadow: 0 0 10px var(--anyx-pink);
    }

    .progress-bar.purple {
        background: var(--anyx-purple);
        box-shadow: 0 0 10px var(--anyx-purple);
    }

    .progress-bar.green {
        background: var(--anyx-green);
        box-shadow: 0 0 10px var(--anyx-green);
    }
    ...
    .action-tile.blue::before {
        background: var(--anyx-blue);
    }

    .action-tile.pink::before {
        background: var(--anyx-pink);
    }

    .action-tile.purple::before {
        background: var(--anyx-purple);
    }

    .action-tile.green::before {
        background: var(--anyx-green);
    }
    ...
    .action-tile.blue .tile-icon svg {
        stroke: var(--anyx-blue);
    }

    .action-tile.pink .tile-icon svg {
        stroke: var(--anyx-pink);
    }

    .action-tile.purple .tile-icon svg {
        stroke: var(--anyx-purple);
    }

    .action-tile.green .tile-icon svg {
        stroke: var(--anyx-green);
    }
    ...
    .alert-row.high {
        border-left-color: var(--anyx-orange);
    }

    .alert-row.medium {
        border-left-color: var(--anyx-cyan);
    }

    .alert-row.low {
        border-left-color: var(--anyx-blue);
    }
    ...
    .alert-row.high .alert-indicator {
        background: var(--anyx-orange);
        box-shadow: 0 0 8px var(--anyx-orange);
    }

    .alert-row.medium .alert-indicator {
        background: var(--anyx-cyan);
        box-shadow: 0 0 8px var(--anyx-cyan);
    }

    .alert-row.low .alert-indicator {
        background: var(--anyx-blue);
        box-shadow: 0 0 8px var(--anyx-blue);
    }
