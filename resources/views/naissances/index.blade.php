                    ...
                    <tr class="border-bottom border-light">
                        ...
                        <td class="pe-4">
                            <div class="action-buttons">
                                ...
                                <form action="{{ route('naissances.archive', $naissance) }}" method="POST" style="display:inline;">
                                    @csrf @method('PATCH')
                                    <button type="submit" class="btn-cuni sm danger" title="Archiver" onclick="return confirm('Archiver cette naissance ?')">
