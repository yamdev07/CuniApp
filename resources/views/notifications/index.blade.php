        ...
        <div class="flex items-start gap-3">
            <div class="mt-1 flex-shrink-0">
                <div class="w-9 h-9 rounded-full flex items-center justify-center icon-bg" 
                     ...
                     style="background: rgba({{ 
                        ...
                        ($notif->type === 'error' ? '239, 68, 68' : '59, 130, 246')) 
                     }}, 0.15)">
            ...
            <div class="flex flex-col items-end space-y-1">
                ...
                <form action="{{ route('notifications.read', $notif->id) }}" method="POST">
                    @csrf
                    <button type="submit" class="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-800 font-medium flex items-center gap-1">
                        <i class="bi bi-check-circle"></i> <span class="hidden sm:inline">Marquer lu</span>
                    </button>
                </form>
                @endif
