...
<div class="cuni-card mb-6" style="
    ...
    <div class="card-body" style="padding: 32px;">
        ...
        <div style="margin-top: 32px; display: flex; gap: 12px; flex-wrap: wrap;">
            <form action="{{ route('subscription.renew') }}" method="POST">
                ...
                <button type="submit" class="btn-cuni" style="
                    background: white;
                    color: var(--primary);
                    border: none;
                ">
            ...
            <button type="button" class="btn-cuni" style="
            ...
            <table class="table" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid var(--surface-border);">
                        ...
                        <td style="padding: 12px; font-weight: 600;">{{ number_format($sub->price, 0, ',', ' ') }} FCFA</td>
...
">
    ...
    ">
        ...
        <form action="{{ route('subscription.cancel') }}" method="POST">
            @csrf
            <input type="hidden" name="subscription_id" value="{{ $subscription->id }}">
            <textarea name="cancellation_reason" class="form-control" rows="3" placeholder="Raison de l'annulation (optionnel)"></textarea>
            <div style="display: flex; gap: 12px; margin-top: 24px; justify-content: flex-end;">
                <button type="button" class="btn-cuni secondary" onclick="document.getElementById('cancelModal').style.display='none'">
                    Retour
                </button>
